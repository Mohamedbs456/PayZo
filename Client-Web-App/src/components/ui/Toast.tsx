...
function ToastItem({
  ...
  return (
    <div
      ...
      className={cn(
        "pointer-events-auto flex max-w-[480px] items-center gap-2.5 rounded-xl bg-surface-inverse px-4 py-3",
        "font-sans text-[13px] font-medium text-text-on-inverse shadow-[0_8px_24px_-6px_rgba(0,0,0,0.32)]",
    ...
    >
      ...
      {toast.tier === "danger" && (
        <button
          ...
          className="flex shrink-0 items-center justify-center rounded text-text-on-inverse/60 transition-colors duration-150 hover:text-text-on-inverse"
        >
